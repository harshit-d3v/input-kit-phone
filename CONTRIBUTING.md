...
Open an issue describing the use case first. This package aims to stay a small, headless primitive, so new API surface is weighed against bundle size and maintenance cost. Check `FUTURE.md` for what's already planned.
